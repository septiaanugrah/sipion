...
/**
 * NotaDinasSearch represents the model behind the search form of `app\models\NotaDinas`.
 */
class NotaDinasSearch extends NotaDinas
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['tanggal', 'perihal', 'created_at', 'updated_at', 'nomor_surat'], 'safe'],
        ];
    }
