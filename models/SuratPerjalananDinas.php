 ...
 */
class SuratPerjalananDinas extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['tanggal', 'nama'], 'required'],
            [['kode_surat', 'nomor_surat', 'tanggal', 'tahun', 'created_at', 'updated_at', 'nama', 'keterangan'], 'safe'],
    ...
    protected function setNoUrut()
    {
        ...
        if(date('Y')==2020)
            $jumlahUrut = $jumlahUrut + 16;
        $this->nomor_surat = ($jumlahUrut + 1) . 'SPPD/RSUD-PB/' .$bulanRomawi . '/' .$year;
