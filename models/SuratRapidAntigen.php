 ...
 */
class SuratRapidAntigen extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['nama', 'no_mr', 'tanggal_lahir', 'alamat', 'provinsi', 'hasil', 'id_dokter'], 'required'],
            [['tanggal', 'tahun', 'created_at', 'updated_at', 'nama', 'no_mr', 'tanggal_lahir', 'nik', 'alamat', 'hasil', 'provinsi', 'kabupaten', 'kecamatan', 'kelurahan'], 'safe'],
