...
class SuratPerintahTugasSearch extends SuratPerintahTugas
{
    ...
    {
        return [
            [['id', 'updated_by', 'created_by','no_urut'], 'integer'],
            [['kode_surat', 'nomor_surat', 'tanggal', 'tahun', 'memerintahkan', 'perintah', 'updated_at', 'created_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'kode_surat', $this->kode_surat])
            ...
            ->andFilterWhere(['like', 'perintah', $this->perintah]);
