...
/**
 * This is the model class for table "nota_dinas".
 *
 * @property int $id
 ...
 */
class NotaDinas extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [[], 'required'],
            [['tanggal', 'tahun', 'created_at', 'updated_at', 'perihal'], 'safe'],
