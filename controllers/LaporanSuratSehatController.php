...
use app\models\LaporanSuratSehat;
...
class LaporanSuratSehatController extends \yii\web\Controller
{
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Surat Keterangan Sehat SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:G1')
                    ->setCellValue('A1', 'LAPORAN SURAT KETERANGAN BERBADAN SEHAT')
                    ->getStyle('A1')
