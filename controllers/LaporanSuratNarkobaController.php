...
use app\models\LaporanSuratNarkoba;
...
class LaporanSuratNarkobaController extends \yii\web\Controller
{
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Surat Bebas Narkoba SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:G1')
                    ->setCellValue('A1', 'LAPORAN SURAT KETERANGAN BEBAS NARKOBA')
                    ->getStyle('A1')
                ...
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('E'. $baseHeader, 'Jenis Kelamin')
                    ->setCellValue('F'. $baseHeader, 'Alamat')
                    ->setCellValue('G'. $baseHeader, 'Keterangan')
                ;
                ...
                foreach ($data['data'] as $d) {
                    ...
                    $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('E' . $baseRow, $d->jenis_kelamin)
                        ->setCellValue('F' . $baseRow, $d->alamat)
                        ->setCellValue('G' . $baseRow, $d->keterangan);
                    $no++;
                    $baseRow++;
                }
                ...
                $spreadsheet->getActiveSheet()->getStyle('A5:G'. ($baseRow-1))
                    ->applyFromArray($styleArray);
