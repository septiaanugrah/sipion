...
use app\models\LaporanSuratPerintahTugas;
...
class LaporanSuratPerintahTugasController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model = new LaporanSuratPerintahTugas;
        // $model->poli = 0;
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Surat Perintah Tugas SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:E1')
                    ->setCellValue('A1', 'LAPORAN SURAT PERINTAH TUGAS')
                    ->getStyle('A1')
                ...
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D'. $baseHeader, 'Memerintahkan')
                    ->setCellValue('E'. $baseHeader, 'Perintah')
                ;
                ...
                foreach ($data['data'] as $d) {
                    ...
                    $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('D' . $baseRow, $d->memerintahkan)
                        ->setCellValue('E' . $baseRow, $d->perintah);
                    $no++;
                    $baseRow++;
                }
                ...
                $spreadsheet->getActiveSheet()->getStyle('A5:E'. ($baseRow-1))
                    ->applyFromArray($styleArray);
