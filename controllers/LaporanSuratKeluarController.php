...
use app\models\LaporanSuratKeluar;
...
class LaporanSuratKeluarController extends \yii\web\Controller
{
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Surat Keluar SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:E1')
                    ->setCellValue('A1', 'LAPORAN SURAT KELUAR')
                    ->getStyle('A1')
                ...
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D'. $baseHeader, 'Alamat Tujuan')
                ...
                foreach ($data['data'] as $d) {
                    ...
                    $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('D' . $baseRow, $d->alamat_tujuan)
