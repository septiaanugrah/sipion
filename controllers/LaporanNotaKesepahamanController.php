...
use app\models\LaporanNotaKesepahaman;
...
class LaporanNotaKesepahamanController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model = new LaporanNotaKesepahaman;
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Nota Kesepahaman SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:D1')
                    ->setCellValue('A1', 'LAPORAN NOTA KESEPAHAMAN')
                    ->getStyle('A1')
