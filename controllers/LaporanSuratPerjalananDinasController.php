...
use app\models\LaporanSuratPerjalananDinas;
...
class LaporanSuratPerjalananDinasController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model = new LaporanSuratPerjalananDinas;
        // $model->poli = 0;
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Surat Perjalanan Dinas SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:E1')
                    ->setCellValue('A1', 'LAPORAN SURAT PERJALANAN DINAS')
                    ->getStyle('A1')
                ...
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('E'. $baseHeader, 'Keterangan')
                ;
                ...
                foreach ($data['data'] as $d) {
                    ...
                    $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('E' . $baseRow, $d->keterangan)
                        ;
                    $no++;
                    $baseRow++;
                }
