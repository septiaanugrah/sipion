...
use app\models\LaporanUndanganKeluar;
...
class LaporanUndanganKeluarController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model = new LaporanUndanganKeluar;
        // $model->poli = 0;
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Undangan Keluar SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:G1')
                    ->setCellValue('A1', 'LAPORAN UNDANGAN KELUAR')
                    ->getStyle('A1')
                ...
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D'. $baseHeader, 'Tempat')
                    ->setCellValue('E'. $baseHeader, 'Pukul')
                    ->setCellValue('F'. $baseHeader, 'Acara')
                ...
                foreach ($data['data'] as $d) {
                    ...
                    $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('D' . $baseRow, $d->tempat)
                        ->setCellValue('E' . $baseRow, $d->pukul)
                        ->setCellValue('F' . $baseRow, $d->acara)
