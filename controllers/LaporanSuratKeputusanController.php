...
use app\models\LaporanSuratKeputusan;
...
class LaporanSuratKeputusanController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model = new LaporanSuratKeputusan;
        // $model->poli = 0;
    ...
    public function actionDownload()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            $data = $model->getDataLaporan();
                ...
                $fileName = 'Laporan Surat Keputusan SIRARA (' . $data['judulDokumen'] . ')';
                ...
                $spreadsheet->getActiveSheet()->mergeCells('A1:D1')
                    ->setCellValue('A1', 'LAPORAN SURAT KEPUTUSAN')
                    ->getStyle('A1')
