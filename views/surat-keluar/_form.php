        ...
        <div class="table-responsive">
            <br>
                ...
                <div class="col-md-6">
                    ...
                    <?= $form->field($model, 'alamat_tujuan')->textArea(['maxlength' => true])->label($model->getAttributeLabel('alamat_tujuan')); ?>
                ...
                <div class="col-md-12">
                    ...
                    <?php
                    echo '<label class="control-label">Unggah Hasil Scan Surat Keluar (.PDF)</label>';
