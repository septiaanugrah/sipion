...
/* @var $searchModel app\models\SuratBebasNarkobaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Surat Bebas Narkoba';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="surat-bebas-narkoba-index">
    ...
    <?php 
        if (in_array(Yii::$app->user->identity->akses, [ User::ROLE_ADMIN_LABORATORIUM ])) {
    ?>
    <p>
