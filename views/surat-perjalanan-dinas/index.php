...
/* @var $searchModel app\models\SuratKeputusanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Surat Perintah Perjalanan Dinas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="surat-perjalanan-dinas-index">
                        ...
                        [
                            ...
                            'buttons' => [
                                'leadView' => function ($url, $model) {
                                    $url = Url::to(['surat-perjalanan-dinas/view', 'id' => $model->id]);
                                    return Html::a(Icon::show('eye') . 'Lihat', $url, ['title' => 'view', 'class' => 'btn btn-primary', 'style' => 'width:100%']);
                                },
                                // 'leadUpdate' => function ($url, $model) {
                                //     $url = Url::to(['surat-keputusan/update', 'id' => $model->id]);
