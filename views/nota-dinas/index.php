...
/* @var $searchModel app\models\NotaDinasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Nota Dinas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="nota-dinas-index">
                        ...
                        [
                            ...
                            'buttons' => [
                                'leadView' => function ($url, $model) {
                                    $url = Url::to(['nota-dinas/view', 'id' => $model->id]);
                                    return Html::a(Icon::show('eye') . 'Lihat', $url, ['title' => 'view', 'class' => 'btn bg-primary', 'style' => 'width:100%']);
                                },
                                // 'leadUpdate' => function ($url, $model) {
                                //     $url = Url::to(['nota-dinas/update', 'id' => $model->id]);
