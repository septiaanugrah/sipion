 ...
 * @Last Modified time: 2019-01-06 17:55:29
 */
        ...
        <?php            
            echo Highcharts::widget([
                ...
                'options' => [
                    'credits' => ['enabled' => false],
                    'title' => [
                        'text' => 'Kunjungan 3 Bulan Terakhir',
                    ],
                    'chart' => [
                        'type' => 'column',
                        'height' => 550
                    ...
                    'tooltip' => [
                        ...
                        'pointFormat' => '<tr><td style="color:{series.color};padding:0">{series.name}: </td><td style="padding:0;color:white;"><b>{point.y} Pasien</b></td></tr>',
                        'footerFormat' => '</table>',
                        'shared' => true,
                        'useHTML' => true,
